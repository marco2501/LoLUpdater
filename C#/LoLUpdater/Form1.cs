    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(@"Backup"))
            {
                ...
                if (Directory.Exists(@"Rads"))
                {
                    File.Copy(@"Backup\cg.dll", @"RADS\projects\lol_game_client\releases\" + game + @"\deploy\cg.dll");
                    File.Copy(@"Backup\cgd3d9.dll", @"RADS\projects\lol_game_client\releases\" + game + @"\deploy\cgd3d9.dll");
                    File.Copy(@"Backup\cggl.dll", @"RADS\projects\lol_game_client\releases\" + game + @"\deploy\cggl.dll");
                    File.Copy(@"Backup\msvcr120.dll", @"RADS\projects\lol_game_client\releases\" + game + @"\deploy\msvcr120.dll");
                    File.Copy(@"Backup\msvcp120.dll", @"RADS\projects\lol_game_client\releases\" + game + @"\deploy\msvcp120.dll");
                    File.Copy(@"Backup\tbb.dll", @"RADS\projects\lol_game_client\releases\" + game + @"\deploy\tbb.dll");

                    File.Copy(@"Backup\cg.dll", @"RADS\solutions\lol_game_client_sln\releases\" + sln + @"\deploy\cg.dll");
                    File.Copy(@"Backup\cgd3d9.dll", @"RADS\solutions\lol_game_client_sln\releases\" + sln + @"\deploy\cgd3d9.dll");
                    File.Copy(@"Backup\cggl.dll", @"RADS\solutions\lol_game_client_sln\releases\" + sln + @"\deploy\cggl.dll");
                    File.Copy(@"Backup\msvcr120.dll", @"RADS\solutions\lol_game_client_sln\releases\" + sln + @"\deploy\msvcr120.dll");
                    File.Copy(@"Backup\msvcp120.dll", @"RADS\solutions\lol_game_client_sln\releases\" + sln + @"\deploy\msvcp120.dll");
                    File.Copy(@"Backup\tbb.dll", @"RADS\solutions\lol_game_client_sln\releases\" + sln + @"\deploy\tbb.dll");


                    File.Copy(@"Backup\cg.dll", @"RADS\projects\lol_launcher\releases\" + launch + @"\deploy\cg.dll");
                    File.Copy(@"Backup\cgd3d9.dll", @"RADS\projects\lol_launcher\releases\" + launch + @"\deploy\cgd3d9.dll");
                    File.Copy(@"Backup\cggl.dll", @"RADS\projects\lol_launcher\releases\" + launch + @"\deploy\cggl.dll");
                    File.Copy(@"Backup\msvcr120.dll", @"RADS\projects\lol_launcher\releases\" + launch + @"\deploy\msvcr120.dll");
                    File.Copy(@"Backup\msvcp120.dll", @"RADS\projects\lol_launcher\releases\" + launch + @"\deploy\msvcp120.dll");

                    File.Copy(@"Backup\NPSWF32.dll", @"RADS\projects\lol_air_client\releases\" + air + @"\deploy\Adobe AIR\Versions\1.0\Resources\NPSWF32.dll");
                    File.Copy(@"Backup\Adobe Air.dll", @"RADS\projects\lol_air_client\releases\" + air + @"\deploy\Adobe AIR\Versions\1.0\Adobe Air.dll");
                }
                if (Directory.Exists(@"Game"))
                {
